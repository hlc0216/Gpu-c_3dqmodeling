...
#nvcc -c -g 3dPureqPModeling_single_shot_multigpu.cu  -o 3dPureqPModeling_single_shot_multigpu.o
...
#nvcc -o 3dqpmodeling 3dPureqPModeling.o 3dPureqPModeling_single_shot_multigpu.o GPU_kernel.o CPU_function.o read_write.o array_new.o
